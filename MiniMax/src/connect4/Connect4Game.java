...
public class Connect4Game {
    ...
    public int evaluate(char player) {
        ...
        // مكافأة للصفوف، الأعمدة، والأقطار التي تحتوي على قطع اللاعب
        score += calculateScoreForLines(player);

        // عقاب للحركات التي تقترب من إعطاء الخصم الفوز
        score -= calculateScoreForLines(otherPlayer(player));

        return score;
    }

    private int calculateScoreForLines(char player) {
        int score = 0;
        // قم بحساب النقاط بناءً على القطع المتتالية للاعب
        // يمكنك فحص الأعمدة، الصفوف، والأقطار
        return score;
    }


    public int evaluate1(char player) {
        ...
        // If none of the above conditions are met, return 0 as a default
        return 0;
    }
